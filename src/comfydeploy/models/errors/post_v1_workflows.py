...
class PostV1WorkflowsResponseBodyData(BaseModel):
    error: str
...
class PostV1WorkflowsResponseBody(Exception):
    ...
    def __init__(self, data: PostV1WorkflowsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, PostV1WorkflowsResponseBodyData)
