...
from comfydeploy.models.components import cancelfunctionbody as components_cancelfunctionbody, httpmetadata as components_httpmetadata
...
class CancelRunRunRunIDCancelPostRequest(BaseModel):
    run_id: Annotated[str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))]
    cancel_function_body: Annotated[components_cancelfunctionbody.CancelFunctionBody, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
