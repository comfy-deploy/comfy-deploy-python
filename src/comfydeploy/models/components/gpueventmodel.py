...
class GPUEventModel(BaseModel):
    ...
    gpu: Nullable[MachineGPUOutput]
    gpu_provider: GPUProviderType
    WS_GPU: Annotated[Final[Nullable[WorkspaceGPU]], pydantic.Field(alias="ws_gpu")] = WorkspaceGPU.FOUR_THOUSAND_AND_NINETY # type: ignore
    ...
    def serialize_model(self, handler):
        optional_fields = ["created_at", "updated_at", "session_timeout", "session_id", "modal_function_id", "tunnel_url", "cost_item_title", "cost"]
        nullable_fields = ["org_id", "machine_id", "start_time", "end_time", "gpu", "ws_gpu", "session_timeout", "session_id", "modal_function_id", "tunnel_url", "cost_item_title", "cost"]
        null_default_fields = []
