...
class GetDeploymentResponseBodyData(BaseModel):
    error: str
...
class GetDeploymentResponseBody(Exception):
    ...
    def __init__(self, data: GetDeploymentResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetDeploymentResponseBodyData)
