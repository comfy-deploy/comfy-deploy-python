...
class GetV1MachinesMachineIDResponseBodyData(BaseModel):
    error: str
...
class GetV1MachinesMachineIDResponseBody(Exception):
    ...
    def __init__(self, data: GetV1MachinesMachineIDResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetV1MachinesMachineIDResponseBodyData)
