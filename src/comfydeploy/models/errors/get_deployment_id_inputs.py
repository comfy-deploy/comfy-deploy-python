...
class GetDeploymentIDInputsResponseBodyData(BaseModel):
    error: str
...
class GetDeploymentIDInputsResponseBody(Exception):
    ...
    def __init__(self, data: GetDeploymentIDInputsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetDeploymentIDInputsResponseBodyData)
