...
class GetV1WorkflowsWorkflowIDResponseBodyData(BaseModel):
    error: str
...
class GetV1WorkflowsWorkflowIDResponseBody(Exception):
    ...
    def __init__(self, data: GetV1WorkflowsWorkflowIDResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetV1WorkflowsWorkflowIDResponseBodyData)
