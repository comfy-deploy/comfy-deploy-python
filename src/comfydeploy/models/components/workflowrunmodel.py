...
from .workflowrunoutputmodel import WorkflowRunOutputModel, WorkflowRunOutputModelTypedDict
...
class WorkflowRunModel(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["ended_at", "queued_at", "started_at", "progress", "is_realtime", "webhook_intermediate_status", "outputs"]
        nullable_fields = ["workflow_version_id", "workflow_inputs", "workflow_api", "machine_id", "gpu_event_id", "gpu", "machine_version", "machine_type", "modal_function_call_id", "user_id", "org_id", "live_status", "webhook", "webhook_status", "duration", "cold_start_duration", "cold_start_duration_total", "run_duration", "ended_at", "queued_at", "started_at"]
        null_default_fields = []
