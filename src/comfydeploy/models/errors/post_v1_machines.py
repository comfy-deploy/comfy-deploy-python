...
class PostV1MachinesResponseBodyData(BaseModel):
    error: str
...
class PostV1MachinesResponseBody(Exception):
    ...
    def __init__(self, data: PostV1MachinesResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, PostV1MachinesResponseBodyData)
