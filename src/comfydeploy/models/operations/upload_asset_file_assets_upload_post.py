...
from comfydeploy.models.components import assetresponse as components_assetresponse, body_upload_asset_file_assets_upload_post as components_body_upload_asset_file_assets_upload_post, httpmetadata as components_httpmetadata
...
class UploadAssetFileAssetsUploadPostRequest(BaseModel):
    body_upload_asset_file_assets_upload_post: Annotated[components_body_upload_asset_file_assets_upload_post.BodyUploadAssetFileAssetsUploadPost, FieldMetadata(request=RequestMetadata(media_type="multipart/form-data"))]
    parent_path: Annotated[Optional[str], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = "/"
    r"""Parent folder path"""
