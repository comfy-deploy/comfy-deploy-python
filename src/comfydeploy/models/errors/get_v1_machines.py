...
class GetV1MachinesResponseBodyData(BaseModel):
    error: str
...
class GetV1MachinesResponseBody(Exception):
    ...
    def __init__(self, data: GetV1MachinesResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetV1MachinesResponseBodyData)
