...
class SyncWorkflowRunRunWorkflowSyncPostResponseTypedDict(TypedDict):
    ...
    response_sync_workflow_run_run_workflow_sync_post: NotRequired[List[components_workflowrunoutputmodel.WorkflowRunOutputModelTypedDict]]
...
class SyncWorkflowRunRunWorkflowSyncPostResponse(BaseModel):
    ...
    response_sync_workflow_run_run_workflow_sync_post: Optional[List[components_workflowrunoutputmodel.WorkflowRunOutputModel]] = None
    r"""Successful Response"""
