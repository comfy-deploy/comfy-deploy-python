...
from comfydeploy.models.components import deletesessionresponse as components_deletesessionresponse, httpmetadata as components_httpmetadata
...
class DeleteSessionSessionSessionIDDeleteResponseTypedDict(TypedDict):
    ...
    delete_session_response: NotRequired[components_deletesessionresponse.DeleteSessionResponseTypedDict]
...
class DeleteSessionSessionSessionIDDeleteResponse(BaseModel):
    ...
    delete_session_response: Optional[components_deletesessionresponse.DeleteSessionResponse] = None
    r"""Successful Response"""
