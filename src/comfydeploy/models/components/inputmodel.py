...
DefaultValue = Union[str, int, float, bool, List[Any]]


MinValueTypedDict = Union[int, float]


MinValue = Union[int, float]


MaxValueTypedDict = Union[int, float]


MaxValue = Union[int, float]


StepTypedDict = Union[int, float]
...
class InputModel(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["default_value", "min_value", "max_value", "display_name", "description", "enum_options", "step"]
        nullable_fields = ["default_value", "min_value", "max_value", "enum_options", "step"]
        null_default_fields = []
