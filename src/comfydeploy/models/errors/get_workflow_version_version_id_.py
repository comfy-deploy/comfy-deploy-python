...
class GetWorkflowVersionVersionIDResponseBodyData(BaseModel):
    error: str
...
class GetWorkflowVersionVersionIDResponseBody(Exception):
    ...
    def __init__(self, data: GetWorkflowVersionVersionIDResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetWorkflowVersionVersionIDResponseBodyData)
